...
const flattenScheduleOntoAssessment = (assessment, schedule) => {
  ...
  return {
    ...
    exam_id: schedule.exam_id ?? schedule.examId ?? schedule.exam?.id ?? assessment.exam_id ?? assessment.examId ?? assessment.exam?.id ?? '',
...
const normalizeAssessment = (assessment) => ({
  ...
  exam_id: assessment?.exam_id ?? assessment?.examId ?? assessment?.exam?.id ?? '',
