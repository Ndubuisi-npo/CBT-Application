<template>
  <div class="space-y-6">
    ...
    <FileDropzone v-if="state.page === 'idle'" @file-selected="handleFileSelected" />
    ...
    <!-- Success banner -->
    <ImportResultBanner v-if="state.page === 'done'" :import-result="state.importResult" @import-another="reset" />
