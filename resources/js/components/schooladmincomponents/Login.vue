<template>
  <div class="min-h-screen bg-[#f3f6fb] lg:grid lg:grid-cols-[1.05fr_0.95fr]">
    ...
    <div class="flex min-h-screen items-center justify-center px-6 py-10 sm:px-8">
      <div class="sa-surface w-full max-w-xl rounded-[32px] p-8 shadow-2xl shadow-slate-900/8 sm:p-10">
        ...
        <form class="space-y-6" @submit.prevent="submitLogin">
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <input id="school-email" v-model="form.email" type="email" placeholder="admin@school.edu" class="sa-input pl-12 text-base" />
            </div>
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <input
                ...
                class="sa-input pl-12 pr-12 text-base"
              />
          ...
          <button type="submit" :disabled="authStore.loading" class="sa-button-primary flex w-full items-center justify-center gap-2 py-4 text-base">
