<template>
  ...
  >
    ...
    <div class="sa-surface relative z-10 w-full max-w-md rounded-[28px] p-8 shadow-2xl shadow-slate-900/10">
      ...
      <form class="space-y-6" @submit.prevent="submitLogin">
        <div class="space-y-2">
          ...
          <div class="relative">
            ...
            <input id="email" v-model="form.email" type="email" class="sa-input pl-12" placeholder="admin@educbt.com" autocomplete="email" />
          </div>
          <p v-if="errors.email" class="sa-error">{{ errors.email }}</p>
        </div>

        <div class="space-y-2">
          <label for="password" class="sa-label">Password</label>
          <div class="relative">
          ...
          <p v-if="errors.password" class="sa-error">{{ errors.password }}</p>
        </div>
        ...
        <button type="submit" class="sa-button-primary w-full" :disabled="authStore.loading">
